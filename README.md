...
| Accepted optimization | Precision / backend | Latency (100 s audio) | Speedup |
|---|---|---:|---:|
...
| Native CUTLASS decoder-11 | FP16 input, FP32 accumulation/output / CUTLASS | 62.235 ms | 2.1800x |
| cuDNN + WMMA decoder-9 and native final-post | FP16 branch, FP32 residual/output / cuDNN, CUDA WMMA | 60.878 ms | 2.2299x |
| Selected WMMA decoder-12/final | FP16 pointwise, FP32 residual/final / CUDA WMMA | 59.956 ms | 2.2628x |
